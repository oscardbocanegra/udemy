...
#Práctica Herencia Extendida 3: Un hijo ha heredado de su padre todas sus características, 
#sin embargo, tienen diferentes hobbies. Logra que la clase Hijo herede de Padre todos sus 
#métodos y atributos, sobreescribiendo el método hobby() para que se devuelva[1]: "Juego 
#videojuegos en mi tiempo libre" [1]: asegúrate de utilizar return seguido de una cadena de texto
class Padre():
    color_ojos = "marrón"
    tipo_pelo = "rulos"
    altura = "media"
